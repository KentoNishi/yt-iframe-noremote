// https://www.youtube.com/s/player/bc657243/www-widgetapi.vflset/www-widgetapi.js
export const loadWidgetAPI = () => {
...
function la(a,b){a.prototype=ea(b.prototype);a.prototype.constructor=a;if(ka)ka(a,b);else for(var c in b)if("prototype"!=c)if(Object.defineProperties){var d=Object.getOwnPropertyDescriptor(b,c);d&&Object.defineProperty(a,c,d)}else a[c]=b[c];a.L=b.prototype}
...
function qa(a,b){a.h={T:b,U:!0};a.l=a.o}
...
function y(a){for(;a.g.l;)try{var b=a.h(a.g);if(b)return a.g.i=!1,{value:b.value,done:!1}}catch(c){a.g.s=void 0,qa(a.g,c)}a.g.i=!1;if(a.g.h){b=a.g.h;a.g.h=null;if(b.U)throw b.T;return{value:b.return,done:!0}}return{value:void 0,done:!0}}
...
var g=this,h=!1;return{resolve:f(this.N),reject:f(this.l)}};
b.prototype.N=function(f){if(f===this)this.l(new TypeError("A Promise cannot resolve to itself"));else if(f instanceof b)this.P(f);else{a:switch(typeof f){case "object":var g=null!=f;break a;case "function":g=!0;break a;default:g=!1}g?this.M(f):this.o(f)}};
b.prototype.M=function(f){var g=void 0;try{g=f.then}catch(h){this.l(h);return}"function"==typeof g?this.R(g,f):this.o(f)};
b.prototype.l=function(f){this.A(2,f)};
b.prototype.o=function(f){this.A(1,f)};
b.prototype.A=function(f,g){if(0!=this.h)throw Error("Cannot settle("+f+", "+g+"): Promise already settled in state"+this.h);this.h=f;this.i=g;2===this.h&&this.O();this.C()};
b.prototype.O=function(){var f=this;e(function(){if(f.Y()){var g=u.console;"undefined"!==typeof g&&g.error(f.i)}},1)};
b.prototype.Y=function(){if(this.s)return!1;var f=u.CustomEvent,g=u.Event,h=u.dispatchEvent;if("undefined"===typeof h)return!0;"function"===typeof f?f=new f("unhandledrejection",{cancelable:!0}):"function"===typeof g?f=new g("unhandledrejection",{cancelable:!0}):(f=u.document.createEvent("CustomEvent"),f.initCustomEvent("unhandledrejection",!1,!0,f));f.promise=this;f.reason=this.i;return h(f)};
b.prototype.C=function(){if(null!=this.g){for(var f=0;f<this.g.length;++f)k.h(this.g[f]);this.g=null}};
var k=new c;b.prototype.P=function(f){var g=this.j();f.B(g.resolve,g.reject)};
b.prototype.R=function(f,g){var h=this.j();try{f.call(g,h.resolve,h.reject)}catch(l){h.reject(l)}};
...
var n=[],t=0;do n.push(void 0),t++,d(h.value).B(p(n.length-1),m),h=g.next();while(!h.done)})};
return b});
...
c.prototype=b.prototype;a.L=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.oa=function(d,e,k){for(var f=Array(arguments.length-2),g=2;g<arguments.length;g++)f[g-2]=arguments[g];return b.prototype[e].apply(d,f)}}
...
function wb(a){return a.W===jb?a.toJSON():tb(a)}
;function xb(a,b,c){var d=a.v,e=ib(d);if(e&2)throw Error();yb(d,e,b,c);return a}
...
;function N(a,b,c){this.v=rb(a,b,c)}
N.prototype.toJSON=function(){if(mb)var a=zb(this,this.v,!1);else a=vb(this.v,wb,void 0,void 0,!1),a=zb(this,a,!0);return a};
N.prototype.W=jb;N.prototype.toString=function(){return zb(this,this.v,!1).toString()};
function zb(a,b,c){var d=Pa?void 0:a.constructor.X;var e=ib(c?a.v:b);a=b.length;if(!a)return b;var k;if(L(c=b[a-1])){a:{var f=c;var g={},h=!1,l;for(l in f){var m=f[l];if(Array.isArray(m)){var p=m;if(nb(m,d,+l)||lb(m)&&0===m.size)m=null;m!=p&&(h=!0)}null!=m?g[l]=m:h=!0}if(h){for(var n in g){f=g;break a}f=null}}f!=c&&(k=!0);a--}for(l=+!!(e&512)-1;0<a;a--){n=a-1;c=b[n];n-=l;if(!(null==c||nb(c,d,n)||lb(c)&&0===c.size))break;var t=!0}if(!k&&!t)return b;b=Array.prototype.slice.call(b,0,a);f&&b.push(f);
return b}
;function Ab(a){this.v=rb(a)}
la(Ab,N);function Bb(a){this.v=rb(a)}
...
Bb.X=[10,6];var Lb="platform platformVersion architecture model uaFullVersion bitness fullVersionList wow64".split(" ");function Mb(a){var b;return null!=(b=a.google_tag_data)?b:a.google_tag_data={}}
...
var Tb=new P("about:invalid#zClosurez");function Ub(a){this.V=a}
...
function Wb(a,b){b=void 0===b?Vb:b;if(a instanceof P)return a;for(var c=0;c<b.length;++c){var d=b[c];if(d instanceof Ub&&d.V(a))return new P(a)}}
...
if("undefined"!==typeof a){var b=new a,c={},d=c;b.port1.onmessage=function(){if(void 0!==c.next){c=c.next;var e=c.H;c.H=null;e()}};
return function(e){d.next={H:e};d=d.next;b.port2.postMessage(0)}}return function(e){z.setTimeout(e,0)}}
...
R.prototype.i=!1;R.prototype.dispose=function(){this.i||(this.i=!0,this.D())};
R.prototype.addOnDisposeCallback=function(a,b){this.i?void 0!==b?a.call(b):a():(this.j||(this.j=[]),this.j.push(void 0!==b?B(a,b):a))};
R.prototype.D=function(){if(this.j)for(;this.j.length;)this.j.shift()()};function S(a){R.call(this);this.s=1;this.l=[];this.o=0;this.g=[];this.h={};this.A=!!a}
...
function nc(a,b,c){var d=oc;if(a=d.h[a]){var e=d.g;(a=a.find(function(k){return e[k+1]==b&&e[k+2]==c}))&&d.F(a)}}
q.F=function(a){var b=this.g[a];if(b){var c=this.h[b];0!=this.o?(this.l.push(a),this.g[a+1]=function(){}):(c&&Ua(c,a),delete this.g[a],delete this.g[a+1],delete this.g[a+2])}return!!b};
q.K=function(a,b){var c=this.h[a];if(c){for(var d=Array(arguments.length-1),e=1,k=arguments.length;e<k;e++)d[e-1]=arguments[e];if(this.A)for(e=0;e<c.length;e++){var f=c[e];pc(this.g[f+1],this.g[f+2],d)}else{this.o++;try{for(e=0,k=c.length;e<k&&!this.i;e++)f=c[e],this.g[f+1].apply(this.g[f+2],d)}finally{if(this.o--,0<this.l.length&&0==this.o)for(;c=this.l.pop();)this.F(c)}}return 0!=e}return!1};
function pc(a,b,c){kc(function(){a.apply(b,c)})}
q.clear=function(a){if(a){var b=this.h[a];b&&(b.forEach(this.F,this),delete this.h[a])}else this.g.length=0,this.h={}};
q.D=function(){S.L.D.call(this);this.clear();this.l.length=0};var qc=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function rc(a){var b=a.match(qc);a=b[1];var c=b[2],d=b[3];b=b[4];var e="";a&&(e+=a+":");d&&(e+="//",c&&(e+=c+"@"),e+=d,b&&(e+=":"+b));return e}
...
function Rc(a){oc.K.apply(oc,arguments)}
...
function Tc(a,b,c){X||(X={},Uc=new Set,Ic(window,"message",function(d){a:if(Uc.has(d.origin)){try{var e=JSON.parse(d.data)}catch(f){break a}var k=X[e.id];k&&d.origin===k.S&&(d=k.Z,d.s=!0,d.s&&(G(d.o,d.sendMessage,d),d.o.length=0),d.G(e))}}));
a=String(W(a,"host"));X[c]={Z:b,S:a};Uc.add(a)}
var X=null,Uc=null;var Vc=window;
function Y(a,b,c){this.l=this.g=this.h=null;this.i=0;this.s=!1;this.o=[];this.j=null;this.C={};if(!a)throw Error("YouTube player element ID required.");this.id=Aa(this);this.A=c;c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"===a.tagName.toLowerCase(),b.host||(b.host=c?rc(a.src):"https://www.youtube.com"),this.h=new Sc(b),c||(b=Wc(this,a),this.l=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.g=a,this.g.id||(this.g.id="widget"+Aa(this.g)),V[this.g.id]=this,window.postMessage){this.j=
...
q.G=function(a){Zc(this,a.event,a)};
q.addEventListener=function(a,b){var c=b;"string"===typeof b&&(c=function(){window[b].apply(window,arguments)});
if(!c)return this;this.j.subscribe(a,c);$c(this,a);return this};
function Yc(a,b){b=b.split(".");if(2===b.length){var c=b[1];a.A===b[0]&&$c(a,c)}}
...
function Zc(a,b,c){a.j.i||(c={target:a,data:c},a.j.K(b,c),Rc(a.A+"."+b,c))}
...
c.setAttribute("width",b.toString());(b=W(a.h,"height"))&&c.setAttribute("height",b.toString());var f=a.I();f.enablejsapi=window.postMessage?1:0;window.location.host&&(f.origin=window.location.protocol+"//"+window.location.host);f.widgetid=a.id;window.location.href&&G(["debugjs","debugcss"],function(h){var l=window.location.href;var m=l.search(uc);b:{var p=0;for(var n=h.length;0<=(p=l.indexOf(h,p))&&p<m;){var t=l.charCodeAt(p-1);if(38==t||63==t)if(t=l.charCodeAt(p+n),!t||61==t||38==t||35==t)break b;
...
return c}
q.J=function(){this.g&&this.g.contentWindow?this.sendMessage({event:"listening"}):window.clearInterval(this.i)};
function Xc(a){Tc(a.h,a,a.id);a.i=Lc(a.J.bind(a));Ic(a.g,"load",function(){window.clearInterval(a.i);a.i=Lc(a.J.bind(a))})}
function $c(a,b){a.C[b]||(a.C[b]=!0,ad(a,"addEventListener",[b]))}
...
;function Z(a,b){Y.call(this,a,Object.assign({title:"video player",videoId:"",width:640,height:360},b||{}),"player");this.u={};this.playerInfo={};this.videoTitle=""}
la(Z,Y);q=Z.prototype;q.I=function(){var a=W(this.h,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};window!==window.top&&document.referrer&&(a.widget_referrer=document.referrer.substring(0,256));if(c=W(this.h,"embedConfig")){if(A(c))try{c=JSON.stringify(c)}catch(d){console.error("Invalid embed config JSON",d)}a.embed_config=c}return a};
q.G=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(A(a))for(var c in a)a.hasOwnProperty(c)&&(this.u[c]=a[c]);break;case "infoDelivery":dd(this,a);break;case "initialDelivery":A(a)&&(window.clearInterval(this.i),this.playerInfo={},this.u={},ed(this,a.apiInterface),dd(this,a));break;default:Zc(this,b,a)}};
function dd(a,b){if(A(b)){for(var c in b)b.hasOwnProperty(c)&&(a.playerInfo[c]=b[c]);a.playerInfo.hasOwnProperty("videoData")&&(b=a.playerInfo.videoData,b.hasOwnProperty("title")&&b.title?(b=b.title,b!==a.videoTitle&&(a.videoTitle=b,a.g.setAttribute("title",b))):(a.videoTitle="",a.g.setAttribute("title","YouTube "+W(a.h,"title"))))}}
function ed(a,b){G(b,function(c){this[c]||("getCurrentTime"===c?this[c]=function(){var d=this.playerInfo.currentTime;if(1===this.playerInfo.playerState){var e=(Date.now()/1E3-this.playerInfo.currentTimeLastUpdated_)*this.playerInfo.playbackRate;0<e&&(d+=Math.min(e,1))}return d}:bd(c)?this[c]=function(){this.playerInfo={};
this.u={};ad(this,c,arguments);return this}:cd(c)?this[c]=function(){var d=0;
0===c.search("get")?d=3:0===c.search("is")&&(d=2);return this.playerInfo[c.charAt(d).toLowerCase()+c.substr(d+1)]}:this[c]=function(){ad(this,c,arguments);
return this})},a)}
